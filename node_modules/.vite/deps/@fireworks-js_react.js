...
// node_modules/@fireworks-js/react/dist/index.es.js
...
function m(e, t, i, s) {
  const n2 = Math.pow;
  return Math.sqrt(n2(e - i, 2) + n2(t - s, 2));
}
function x(e, t, i = 1) {
  if (e > 360 || e < 0)
...
var S = class {
  ...
  constructor({
    ...
    for (this.x = t, this.y = i, this.ctx = s, this.hue = n2, this.gravity = a, this.friction = r, this.flickering = p2, this.lineWidth = l, this.explosionLength = d2, this.angle = c(0, Math.PI * 2), this.speed = o(1, 10), this.brightness = o(u2.min, u2.max), this.decay = c(h.min, h.max); this.explosionLength--; )
...
var E = class {
  ...
  usePointer(t, i) {
    const { click: s, move: n2 } = this.mouseOptions;
    (s || n2) && (this.x = t.pageX - this.canvas.offsetLeft, this.y = t.pageY - this.canvas.offsetTop, this.active = i);
  }
  pointerDown(t) {
...
var z = class {
  ...
  mount() {
    ...
    const t = 1e3 / this.fps, i = (s) => {
      ...
      const n2 = s - this.now;
      n2 >= t - this.tolerance && (this.render(), this.now = s - n2 % t, this.tick += n2 * (this.options.intensity * Math.PI) / 1e3);
    };
    this.rafId = requestAnimationFrame(i);
  }
  unmount() {
...
var C = class {
  ...
  constructor({
    ...
    for (this.x = t, this.y = i, this.sx = t, this.sy = i, this.dx = s, this.dy = n2, this.ctx = h, this.hue = a, this.speed = r, this.traceLength = u2, this.acceleration = p2, this.totalDistance = m(t, i, s, n2), this.angle = Math.atan2(n2 - i, s - t), this.brightness = o(50, 70); this.traceLength--; )
      this.coordinates.push([t, i]);
  }
  update(t) {
...
var T = class {
  ...
  drawTrace() {
    ...
    for (; t--; )
      this.traces[t].draw(), this.traces[t].update((i, s, n2) => {
        this.initExplosion(i, s, n2), this.sound.play(), this.traces.splice(t, 1);
      });
  }
  initExplosion(t, i, s) {
    const {
...
// node_modules/@fireworks-js/react/dist/index.es.js
var m2 = import_react.default.forwardRef(
  ({ children: a, options: c2, autostart: s = true, ...i }, o2) => {
    const t = (0, import_react.useRef)(null), r = (0, import_react.useRef)(null);
    return (0, import_react.useImperativeHandle)(o2, () => ({
      get isRunning() {
    ...
    })), (0, import_react.useEffect)(() => (r.current || (r.current = new T(t.current, c2)), s && r.current.start(), () => {
      r.current.stop();
...
//# sourceMappingURL=@fireworks-js_react.js.map
